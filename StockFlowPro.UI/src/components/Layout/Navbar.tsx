                        ...
                        <div className="relative" ref={userDropdownRef}>
                            ...
                            >
                                ...
                                <div className="user-info-wrapper hidden lg:block">
                                    <span className="user-name block text-sm font-semibold">
                                        {currentUser.fullName ||
                                            currentUser.email ||
                                            "User"}
                                    </span>
                                    <span className="user-role-badge block text-xs text-white/70">
                                        {getRoleName(currentUser.role)}
                                    </span>
                                </div>
                                <ChevronDown
                                    className={`h-4 w-4 text-white/60 transition-transform duration-300 ${isUserDropdownOpen ? "rotate-180" : ""}`}
                                />
                            </button>
                                        ...
                                        {userMenuItems
                                            ...
                                            .map((item) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div
                                                            className={`item-icon ${item.isAdmin ? "admin-icon" : ""}`}
                                                        >
