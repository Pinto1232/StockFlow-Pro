        ...
        <div className="mt-3 space-y-3">
          ...
          {demoUsers.map((user, index) => (
            <div
              ...
              style={{
                backgroundColor: user.color.includes('red') ? '#fef2f2' : 
                               user.color.includes('blue') ? '#eff6ff' : '#f0fdf4',
                borderColor: user.color.includes('red') ? '#fecaca' : 
                            user.color.includes('blue') ? '#dbeafe' : '#bbf7d0',
              }}
            >
          ...
          <div className="mt-3 p-2 bg-yellow-50 border border-yellow-200 rounded-md">
            <p className="text-xs text-yellow-800">
              ...
              This is a demo environment. These credentials are for testing purposes only.
            </p>
          </div>
        </div>
      )}
