...
public interface ISubscriptionPlanService
{
    ...
    /// <returns>Subscription plan DTO if found, null otherwise</returns>
    Task<SubscriptionPlanDto?> GetByNameAsync(string name);
    ...
    Task<IEnumerable<SubscriptionPlanDto>> GetPublicPlansAsync();
    ...
    /// <returns>Subscription plan DTO if found, null otherwise</returns>
    Task<SubscriptionPlanDto?> GetByStripeProductIdAsync(string stripeProductId);
    ...
    /// <returns>Subscription plan DTO if found, null otherwise</returns>
    Task<SubscriptionPlanDto?> GetByStripePriceIdAsync(string stripePriceId);
    ...
    /// <returns>Subscription plan DTO if found, null otherwise</returns>
    Task<SubscriptionPlanDto?> GetByPayPalPlanIdAsync(string payPalPlanId);
