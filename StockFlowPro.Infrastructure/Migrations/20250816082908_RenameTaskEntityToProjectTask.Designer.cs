...
namespace StockFlowPro.Infrastructure.Migrations
{
    ...
    [Migration("20250816082908_RenameTaskEntityToProjectTask")]
    partial class RenameTaskEntityToProjectTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockFlowPro.Domain.Entities.ProjectTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AssigneeData")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("[]");
            ...
            modelBuilder.Entity("StockFlowPro.Domain.Entities.ProjectTask", b =>
                {
                    b.HasOne("StockFlowPro.Domain.Entities.Employee", "Employee")
                        .WithMany("Tasks")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StockFlowPro.Domain.Entities.ProjectTask", "ParentTask")
                        .WithMany("Subtasks")
