...
[Authorize]
public class ProductsControllerEnhanced : ControllerBase
{
    private readonly IMediator _mediator;
    private readonly IMapper _mapper;

    public ProductsControllerEnhanced(IMediator mediator, IMapper mapper)
    {
        _mediator = mediator;
        _mapper = mapper;
    }
    ...
    // Keep all your existing methods (CreateProduct, UpdateProduct, etc.)
    // They remain the same but can also benefit from enhanced responses
}
